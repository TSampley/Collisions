...
public class Ball extends TransformGroup
{
    ...
    public Appearance createAppearance(Color ambient, Color emmisive, Color diffuse, Color specular, float shinniness)
    {
...
//    	ap.setTransparencyAttributes(ta);
    ...
    {
    	return Math.sqrt((origin.x - b.origin.x)*(origin.x - b.origin.x) + (origin.y - b.origin.y)*(origin.y - b.origin.y) + (origin.z - b.origin.z)*(origin.z - b.origin.z));
    }
